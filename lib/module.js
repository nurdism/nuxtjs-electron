  ...
  return new Promise((resolve, reject) => {
    ...
    compiler.watch({}, (err, stats) => {
      ...
      if (messages.errors.length) {
        console.log(chalk.black.bgRed(' ERROR '), chalk.red('Failed to compile.'))
        messages.errors.forEach(e => console.log(e))
        return resolve()
      }

      if (messages.warnings.length) {
        console.log(`${chalk.black.bgYellow(' DONE ')} ${chalk.green(`Compiled main with warnings in ${stats.startTime - stats.endTime}ms`)}`)
